...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public XLuaStudy.MyInvokeLua.ICall __Gen_Delegate_Imp13(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                XLuaStudy.MyInvokeLua.ICall __gen_ret = (XLuaStudy.MyInvokeLua.ICall)translator.GetObject(L, errFunc + 1, typeof(XLuaStudy.MyInvokeLua.ICall));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public void __Gen_Delegate_Imp16(object p0, bool p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Threading.Tasks.Task __Gen_Delegate_Imp32(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Threading.Tasks.Task<int> __Gen_Delegate_Imp33(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(XLuaStudy.MyInvokeLua.MyCallNew))
			{
			    return new XLuaStudy.MyInvokeLua.MyCallNew(__Gen_Delegate_Imp13);
			}
