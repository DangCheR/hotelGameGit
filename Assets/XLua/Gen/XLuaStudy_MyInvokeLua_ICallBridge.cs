...
{
    public class XLuaStudyMyInvokeLuaICallBridge : LuaBase, XLuaStudy.MyInvokeLua.ICall
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new XLuaStudyMyInvokeLuaICallBridge(reference, luaenv);
		}
		
		public XLuaStudyMyInvokeLuaICallBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		int XLuaStudy.MyInvokeLua.ICall.Add(int a, int b)
		{
        ...
        int XLuaStudy.MyInvokeLua.ICall.Mult 
        {
		...
		event System.EventHandler<XLuaStudy.MyEvent> XLuaStudy.MyInvokeLua.ICall.PropertyChanged
		{
			add
			{
#if THREAD_SAFE || HOTFIX_ENABLE
        ...
        object XLuaStudy.MyInvokeLua.ICall.this[int index]
		{
		    get
			{
#if THREAD_SAFE || HOTFIX_ENABLE
